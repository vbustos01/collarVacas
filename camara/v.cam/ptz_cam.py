class ptzcam():
    ...
    #Netcat camera (on my local network) Port 8899
        #self.mycam = ONVIFCamera('192.168.0.108', 80, 'admin', 'ufro_ufro_ufro', '/home/victor/collarvacas/camara/python-onvif/wsdl')
        self.mycam = ONVIFCamera('192.168.1.108', 80, 'admin', 'ufro_ufro_ufro', '/home/victor/collarvacas/camara/python-onvif/wsdl')
