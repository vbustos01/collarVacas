class ptzcam(): 
    ...
    #Netcat camera (on my local network) Port 8899
        ...
        self.mycam = ONVIFCamera('172.22.120.193', 80, 'admin', 'ufro_ufro_ufro', '/home/pi/collarVacas/camara/python-onvif/wsdl')
...
#Absolute move functions --NO ERRORS BUT CAMERA DOES NOT MOVE
    def move_abspantilt(self, pan, tilt, zoom, velocity):
        ...
        print 'Absolute move pan-tilt requested:', pan, tilt,zoom, velocity
        sleep(2.0)
...
#Relative move functions --NO ERRORS BUT CAMERA DOES NOT MOVE
    def move_relative(self, pan, tilt, zoom, velocity):
        from time import sleep
        self.requestr.Translation.PanTilt._x = pan
        self.requestr.Translation.PanTilt._y = tilt
        self.requestr.Translation.Zoom._x = zoom
        self.requestr.Speed.PanTilt._x = velocity
        self.requestr.Speed.PanTilt._y = velocity
        self.requestr.Speed.Zoom._x = velocity
